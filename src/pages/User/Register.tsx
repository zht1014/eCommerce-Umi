...
const Register: React.FC = () => {
    ...
    const handleRegister = async (values: any) => {
        ...
        try {
            const res = await axios.post('https://104-248-98-53.nip.io/users/api/user', {
            ...
            if (res.data.success) {
                ...
                const loginRes = await axios.post('https://104-248-98-53.nip.io/users/login', {
                    username: values.username,
                    password: values.password,
                });
                ...
                const assignRole = await axios.post('https://104-248-98-53.nip.io/users/api/user-roles', [{
                    id: 0,
                    userId: userId,
                    roleId: 7
                }],
